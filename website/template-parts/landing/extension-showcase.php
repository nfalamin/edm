...
$chrome_ext_url = esc_url(get_template_directory_uri() . '/downloads/edm-chrome-extension-v1.0.0.zip');
$edge_ext_url = esc_url(get_template_directory_uri() . '/downloads/edm-edge-extension-v1.0.0.zip');
$firefox_ext_url = esc_url(get_template_directory_uri() . '/downloads/edm-firefox-extension-v1.0.0.zip');
?>
