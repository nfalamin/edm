...
let allDocsCache = [];
let currentContentStatusFilter = 'All';
...
function filterContentByStatus(status) {
    currentContentStatusFilter = status;
    renderContentCards();
}
...
function renderContentCards() {
    ...
    if (currentContentStatusFilter === 'Published') {
        filtered = filtered.filter(d => d.isPublished);
    } else if (currentContentStatusFilter === 'Draft') {
...
function openEditor(id) {
    ...
    if (window.edmEditor && typeof window.edmEditor.loadDocument === 'function') {
        ...
        if (window.edmApp && typeof window.edmApp.navigateTo === 'function') {
            window.edmApp.navigateTo('content-editor');
...
function openReplaceModal(id, docType) {
