...
class EdmAuthService {
    ...
    updateUserUI() {
        ...
        const nameEl = document.getElementById("admin-user-name") || document.getElementById("header-profile-name");
        const roleEl = document.getElementById("admin-user-role") || document.getElementById("header-profile-role");
        const emailEl = document.getElementById("profile-menu-email");
        const badgeEl = document.getElementById("admin-role-badge");

        if (nameEl) nameEl.textContent = this.currentUser.displayName || this.currentUser.username || "Admin";
        if (roleEl) roleEl.textContent = (this.currentUser.role || "ADMIN").replace("_", " ");
