...
get_header(); ?>
    ...
    <main>
        <!-- 1. HERO SECTION -->
        <section class="hero-section relative pt-6 pb-12 sm:pt-10 sm:pb-20 lg:pt-20 lg:pb-32 px-4 sm:px-6 overflow-hidden bg-gradient-to-b from-navy-950 to-navy-900 z-10">
            <div class="absolute inset-0 hero-grid-lines pointer-events-none -z-10"></div>
            <div class="w-full max-w-[96%] 2xl:max-w-[1820px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
                
                <!-- Left Details -->
                <div class="lg:col-span-7 flex flex-col space-y-4 sm:space-y-6 items-center text-center lg:items-start lg:text-left">
                    <div class="hero-badge inline-flex items-center space-x-2 px-3.5 py-1 rounded-full w-fit">
                        <span class="hero-badge-dot w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span>
                        <span class="hero-badge-text text-[11px] sm:text-xs tracking-wider uppercase font-semibold"><?php echo esc_html(get_theme_mod('hero_badge_text', 'Available for Projects')); ?></span>
                    </div>

                    <h1 class="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight leading-tight text-white font-display">
                        ...
                        <span class="text-gradient-cyan">Growth</span> <br class="hidden sm:inline">
                        <span class="text-slate-400">Through Custom</span> <br class="hidden sm:inline">
                        <!-- TYPING EFFECT PLACEMENT -->
                        <span id="typing-text" class="text-gradient-gold"></span><span class="text-gold animate-pulse">|</span>
                    </h1>

                    <p class="hero-description text-sm sm:text-base md:text-lg max-w-xl leading-relaxed mx-auto lg:mx-0">
                        <?php echo esc_html(get_theme_mod('hero_bio', 'I build transparent, highly-optimized campaigns designed to maximize traffic, generate qualified leads, and grow revenue as a certified SEO Specialist, Google Ads Expert, and Social Media Marketing Strategist.')); ?>
                    </p>

                    <!-- CTAs -->
                    <div class="flex flex-wrap items-center justify-center lg:justify-start gap-3 sm:gap-5 pt-2 sm:pt-4 w-full">
                        <a href="<?php echo esc_url(home_url('/contact/')); ?>" class="btn-premium btn-premium-primary !px-5 !py-2.5 !text-xs sm:!text-sm">
                            Book Strategy Session
                        </a>
                        <a href="<?php echo function_exists('edm_get_cv_url') ? edm_get_cv_url() : get_template_directory_uri() . '/downloads/Alamin-Hossain-CV.pdf'; ?>" class="btn-premium btn-premium-outline !px-5 !py-2.5 !text-xs sm:!text-sm" download="Alamin-Hossain-CV.pdf">
                            <i class="fa-solid fa-file-arrow-down mr-1.5 text-gold"></i>
                            Download CV
                        </a>
                    </div>

                    <!-- Stats (Animated Counters) -->
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 md:gap-4 pt-6 sm:pt-10 border-t border-white/5 w-full">
                        <div class="flex flex-col items-center lg:items-start text-center lg:text-left">
                            <span class="text-2xl sm:text-3xl font-extrabold text-white font-display stat-num" data-target="<?php echo esc_attr(get_theme_mod('stat_projects', '100')); ?>">0</span>
                            <span class="hero-stat-label text-[10px] sm:text-xs tracking-wider uppercase">Projects Completed</span>
                        </div>
                        <div class="flex flex-col items-center lg:items-start text-center lg:text-left">
                            <span class="text-2xl sm:text-3xl font-extrabold text-white font-display stat-num" data-target="<?php echo esc_attr(get_theme_mod('stat_satisfaction', '95')); ?>">0</span>
                            <span class="hero-stat-label text-[10px] sm:text-xs tracking-wider uppercase">Client Satisfaction %</span>
                        </div>
                        <div class="flex flex-col items-center lg:items-start text-center lg:text-left">
                            <span class="text-2xl sm:text-3xl font-extrabold text-white font-display stat-num" data-target="<?php echo esc_attr(get_theme_mod('stat_experience', '5')); ?>">0</span>
                            <span class="hero-stat-label text-[10px] sm:text-xs tracking-wider uppercase">Years Experience</span>
                        </div>
                        <div class="flex flex-col items-center lg:items-start text-center lg:text-left">
                            <span class="text-2xl sm:text-3xl font-extrabold text-white font-display stat-num" data-target="<?php echo esc_attr(get_theme_mod('stat_businesses', '50')); ?>">0</span>
                            <span class="hero-stat-label text-[10px] sm:text-xs tracking-wider uppercase">Businesses Helped</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="lg:col-span-5 flex justify-center relative items-end w-full overflow-x-clip">
                    <div class="relative w-[65vw] h-[65vw] max-w-[240px] max-h-[240px] sm:max-w-[320px] sm:max-h-[320px] md:max-w-[380px] md:max-h-[380px] lg:max-w-[420px] lg:max-h-[420px] mt-6 sm:mt-10 lg:mt-16 mx-auto aspect-square">
                        ...
                        <div class="absolute bottom-0 w-full h-full rounded-full border-[3px] sm:border-[3.5px] premium-circle z-10"></div>
                
                        <!-- 2. Pop-out Image Wrapper with Custom Clip-Path (Body inside, head pops out) -->
                        <div class="absolute bottom-0 w-full h-full z-30 pointer-events-none" style="clip-path: inset(-100% 0 0 0 round 0 0 50% 50%);">
                            <img src="<?php echo function_exists('portfolio_get_profile_image') ? portfolio_get_profile_image() : get_template_directory_uri() . '/nf.png'; ?>"
                                 class="hero-photo absolute bottom-0 left-1/2 -translate-x-[60%] w-[320px] sm:w-[440px] md:w-[520px] lg:w-[560px] max-w-none drop-shadow-2xl hero-photo-premium"
                                 alt="Alamin Hossain - Profile photo">
                        </div>
                
                        <!-- Floating Badge 1 (Organic Growth) -->
                        <div class="absolute top-4 -left-2 sm:-left-6 glass-panel p-2 sm:p-3 rounded-xl sm:rounded-2xl border border-white/10 flex items-center space-x-2 sm:space-x-3 z-40 animate-bounce" style="animation-duration: 4s;">
                            <span class="text-base sm:text-xl md:text-2xl">📈</span>
                            <div class="flex flex-col text-left">
                                <span class="text-[11px] sm:text-xs md:text-sm font-bold text-white leading-none">+300%</span>
                                <span class="text-[7px] sm:text-[8px] md:text-[9px] text-slate-400 uppercase tracking-wider mt-0.5">Organic Growth</span>
                            </div>
                        </div>
                
                        <!-- Floating Badge 2 (ROAS) -->
                        <div class="absolute bottom-6 -right-2 sm:-right-6 glass-panel p-2 sm:p-3 rounded-xl sm:rounded-2xl border border-white/10 flex items-center space-x-2 sm:space-x-3 z-40 animate-bounce" style="animation-duration: 5s;">
                            <span class="text-base sm:text-xl md:text-2xl">🎯</span>
                            <div class="flex flex-col text-left">
                                <span class="text-[11px] sm:text-xs md:text-sm font-bold text-white leading-none">5X ROAS</span>
                                <span class="text-[7px] sm:text-[8px] md:text-[9px] text-slate-400 uppercase tracking-wider mt-0.5">Google Ads</span>
                            </div>
                        </div>
        ...
        <section class="py-12 trust-section bg-gradient-to-b from-navy-900 to-navy-900/30 px-6">
            <div class="w-full max-w-[96%] 2xl:max-w-[1820px] mx-auto flex flex-col lg:flex-row items-center justify-between gap-8">
        ...
        <section id="about" class="py-16 md:py-24 px-6 relative">
            <div class="w-full max-w-[96%] 2xl:max-w-[1820px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
                ...
                <div class="lg:col-span-5 relative reveal flex justify-center items-center">
                    <div class="relative w-full max-w-[480px] mx-auto">
                        <img src="<?php echo function_exists('portfolio_get_about_chair_image') ? portfolio_get_about_chair_image() : get_template_directory_uri() . '/Assets/images/nf011.png'; ?>" alt="Alamin Hossain sitting" class="w-full h-auto object-contain chair-portrait drop-shadow-2xl">
                    </div>
                </div>
        ...
        <!-- 4.5 EDM FLAGSHIP SOFTWARE SHOWCASE -->
        ...
        <!-- 7.5 LIVE CODE & SEO AUTOMATION ENGINE TERMINAL -->
        <section class="py-16 px-6 relative overflow-hidden bg-gradient-to-b from-navy-950 via-navy-900 to-navy-950 border-t border-white/5">
            <div class="w-full max-w-[96%] 2xl:max-w-[1820px] mx-auto flex flex-col space-y-10">
                <div class="flex flex-col md:flex-row md:items-end justify-between gap-6">
                    <div class="flex flex-col space-y-2">
                        <span class="text-xs tracking-widest text-cyan font-mono uppercase font-bold flex items-center gap-2">
                            <span class="w-2 h-2 rounded-full bg-emerald-400 animate-ping"></span>
                            FULL-STACK ALGORITHMIC ENGINE
                        </span>
                        <h2 class="text-3xl md:text-4xl font-extrabold text-white font-display">Live Code Execution & SEO Automation</h2>
                    </div>
                    <div class="flex items-center space-x-3 bg-navy-900/80 px-4 py-2 rounded-xl border border-cyan/20 text-xs font-mono text-cyan">
                        <i class="fa-solid fa-bolt text-gold"></i>
                        <span>Latency: <strong>8.4ms</strong></span>
                        <span>•</span>
                        <span>Sockets: <strong>32 Active</strong></span>
                    </div>
                </div>

                <!-- Interactive High-Tech Code Terminal -->
                <div class="glass-panel rounded-2xl border border-white/10 shadow-2xl overflow-hidden bg-[#030712]/95 group hover:border-cyan/40 transition-all duration-300">
                    <!-- Terminal Top Bar -->
                    <div class="px-5 py-3.5 bg-navy-900/70 border-b border-white/10 flex items-center justify-between">
                        <div class="flex items-center space-x-2">
                            <span class="w-3 h-3 rounded-full bg-rose-500 inline-block"></span>
                            <span class="w-3 h-3 rounded-full bg-amber-500 inline-block"></span>
                            <span class="w-3 h-3 rounded-full bg-emerald-500 inline-block"></span>
                            <span class="ml-3 text-xs font-mono text-slate-400">alamin@enterprise-server:~/growth-engine/stream.ts</span>
                        </div>
                        <span class="text-[11px] font-mono text-emerald-400 bg-emerald-500/10 px-2.5 py-0.5 rounded-full border border-emerald-500/20">● RUNNING IN PRODUCTION</span>
                    </div>

                    <!-- Terminal Code Body -->
                    <div class="p-6 md:p-8 font-mono text-xs md:text-sm leading-relaxed overflow-x-auto space-y-2">
                        <div class="text-slate-500">// 1. Initialize High-Performance SEO & Socket Pipeline</div>
                        <div><span class="text-indigo-400">import</span> { <span class="text-cyan">EdmSocketCluster</span>, <span class="text-cyan">KeywordVelocityEngine</span> } <span class="text-indigo-400">from</span> <span class="text-emerald-400">'@alamin/growth-core'</span>;</div>
                        <div class="pt-2"><span class="text-indigo-400">const</span> <span class="text-yellow-300">growthCluster</span> = <span class="text-indigo-400">new</span> <span class="text-cyan">EdmSocketCluster</span>({</div>
                        <div class="pl-6"><span class="text-slate-300">concurrency</span>: <span class="text-amber-400">32</span>,</div>
                        <div class="pl-6"><span class="text-slate-300">targetROAS</span>: <span class="text-amber-400">5.2</span>,</div>
                        <div class="pl-6"><span class="text-slate-300">coreWebVitalsTarget</span>: <span class="text-emerald-400">'100/100'</span>,</div>
                        <div class="pl-6"><span class="text-slate-300">securityGate</span>: <span class="text-emerald-400">'SHA-256 Verified'</span></div>
                        <div>});</div>
                        <div class="pt-2 text-slate-500">// 2. Execute Dynamic Real-Time Growth Stream</div>
                        <div><span class="text-yellow-300">growthCluster</span>.<span class="text-blue-400">streamLiveMetrics</span>((<span class="text-cyan">packet</span>) => {</div>
                        <div class="pl-6"><span class="text-slate-400">console</span>.<span class="text-blue-400">log</span>(<span class="text-emerald-400">`🚀 [OPTIMIZED] Organic Traffic: +300% | Latency: ${packet.ms}ms`</span>);</div>
                        <div>});</div>
                        <div class="pt-3 flex items-center space-x-2 text-emerald-400">
                            <span>&gt; SYSTEM STATUS: 32 Sockets synchronized. Lead generation pipelines active...</span>
                            <span class="w-2 h-4 bg-emerald-400 inline-block animate-pulse"></span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="py-24 px-6 border-t border-slate-200 dark:border-white/5 relative bg-slate-50 dark:bg-navy-900/10" x-data="testimonialSlider(<?php echo esc_attr(wp_json_encode($testimonials_data)); ?>)" x-init="init()">
            <div class="w-full max-w-[96%] 2xl:max-w-[1820px] mx-auto flex flex-col space-y-12 overflow-hidden">
        ...
        <section id="contact" class="py-24 px-6 border-t border-white/5 relative">
            <div class="w-full max-w-[96%] 2xl:max-w-[1820px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16">
                    ...
                    <div class="flex flex-col space-y-4">
                        ...
                        <div class="glass-panel p-4 rounded-xl flex items-center space-x-4">
                            ...
                            <div class="flex flex-col">
                                ...
                                <a href="mailto:nfxalamin@gmail.com" class="text-sm font-bold text-white hover:text-cyan transition-colors">nfxalamin@gmail.com</a>
                            </div>
                        </div>
                        ...
                        <div class="glass-panel p-4 rounded-xl flex items-center space-x-4">
                            ...
                            <div class="flex flex-col">
                                <span class="text-[10px] uppercase tracking-wider text-slate-500 font-display font-medium">WhatsApp & Phone</span>
                                <a href="https://wa.me/8801888567189" target="_blank" rel="noopener noreferrer" class="text-sm font-bold text-white hover:text-emerald-400 transition-colors">01888567189 (+880)</a>
                            </div>
                        </div>
                        ...
                        <div class="glass-panel p-4 rounded-xl flex items-center space-x-4">
                            ...
                            <div class="flex flex-col">
                                <span class="text-[10px] uppercase tracking-wider text-slate-500 font-display">Direct Hotline</span>
                                <a href="tel:01888567189" class="text-sm font-bold text-white hover:text-cyan transition-colors font-display">01888567189</a>
                            </div>
                        </div>
