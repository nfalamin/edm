...
export async function loadUpdateManager(component = 'All') {
...
export function filterUpdatesByStatus(status) {
...
function renderUpdateCards() {
    ...
    if (currentStatusFilter !== 'All') {
        filtered = filtered.filter(u => u.status.toLowerCase() === currentStatusFilter.toLowerCase());
    }
...
export async function toggleDownload(id, enabled) {
    try {
...
export async function toggleAutoUpdate(id, enabled) {
    try {
...
export async function setLatest(id) {
    try {
...
export function openUploadModal(id, version, component) {
...
export async function submitUploadArtifact() {
...
export async function submitEditMetadata() {
