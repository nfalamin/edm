...
namespace EDM.Domain.Protocols
{
    ...
    public sealed class EngineProgressReport
    {
        ...
        public IReadOnlyList<WorkerThreadDiagnostic>? WorkerDiagnostics { get; init; }
    }

    public sealed class WorkerThreadDiagnostic
    {
        public int ThreadId { get; init; }
        public string State { get; init; } = "Idle"; // Connecting, Downloading, Writing, Idle, Completed, Stalled
