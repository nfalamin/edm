...
namespace EDM.Services
{
    public class HlsDashDownloadService
    {
        ...
        private static DashRepresentation? SelectDashRepresentation(List<DashRepresentation> representations, string? qualityPreference)
        {
            ...
            if (qualityPreference != null && (qualityPreference.Equals("audio", StringComparison.OrdinalIgnoreCase) || qualityPreference.StartsWith("audio", StringComparison.OrdinalIgnoreCase)))
            {
                return null;
            }
