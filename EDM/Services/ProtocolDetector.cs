...
namespace EDM.Services
{
    ...
    public static class ProtocolDetector
    {
        ...
        public static ProtocolDetectionResult Detect(string urlOrPath, string? contentType = null)
        {
            ...
            if (trimmed.EndsWith(".torrent", StringComparison.OrdinalIgnoreCase) || cleanMime.Contains("application/x-bittorrent"))
            {
                return new ProtocolDetectionResult
                {
            ...
            if (trimmed.Contains(".m3u8", StringComparison.OrdinalIgnoreCase) ||
                trimmed.Contains("format=m3u8", StringComparison.OrdinalIgnoreCase) ||
                trimmed.Contains("manifest=m3u8", StringComparison.OrdinalIgnoreCase) ||
                cleanMime.Contains("application/vnd.apple.mpegurl") ||
                cleanMime.Contains("application/x-mpegurl") ||
                cleanMime.Contains("audio/x-mpegurl"))
            {
                return new ProtocolDetectionResult
                {
            ...
            if (trimmed.Contains(".mpd", StringComparison.OrdinalIgnoreCase) ||
                trimmed.Contains("format=mpd", StringComparison.OrdinalIgnoreCase) ||
                trimmed.Contains("manifest=mpd", StringComparison.OrdinalIgnoreCase) ||
                cleanMime.Contains("application/dash+xml"))
            {
                return new ProtocolDetectionResult
                {
