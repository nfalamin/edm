...
namespace EDM.Services
{
    ...
    public class DownloadQueueScheduler
    {
        ...
        /// <summary>
        /// Returns all items currently in the queue, ordered by dynamic queue score descending.
        /// </summary>
        public IReadOnlyList<QueuedDownloadItem> GetOrderedQueue()
        {
        ...
        /// <summary>
        /// Gets a specific queued item by its download ID.
        /// </summary>
        ...
        /// <summary>
        /// Sets a custom priority for a queued download item.
        /// </summary>
        ...
        /// <summary>
        /// Gets the 1-based queue position for a waiting item, or 0 if not waiting/queued.
        /// </summary>
