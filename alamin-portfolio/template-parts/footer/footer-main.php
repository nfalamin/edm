    ...
    <div class="container">
        <div class="footer-grid">
            ...
            <div class="footer-col footer-col-brand">
                <a href="<?php echo esc_url(home_url('/edm/')); ?>" class="footer-brand">
                    <img src="<?php echo esc_url(get_template_directory_uri() . '/edm-logo.png'); ?>" alt="EDM Logo" style="width: 32px; height: 32px; object-fit: contain; margin-right: 8px;">
            ...
            <div class="footer-col">
                ...
                <ul class="footer-links">
                    <li><a href="<?php echo esc_url(home_url('/edm-features/')); ?>"><?php esc_html_e('Engine Features', 'edm-theme'); ?></a></li>
                    <li><a href="<?php echo esc_url(home_url('/edm/#turbo')); ?>"><?php esc_html_e('32x Socket Turbo', 'edm-theme'); ?></a></li>
                    <li><a href="<?php echo esc_url(home_url('/edm-extensions/')); ?>"><?php esc_html_e('Browser Extensions', 'edm-theme'); ?></a></li>
                    <li><a href="<?php echo esc_url(home_url('/edm-download/')); ?>"><?php esc_html_e('Windows Setup (x64/ARM)', 'edm-theme'); ?></a></li>
                    <li><a href="<?php echo esc_url(home_url('/edm/#pricing')); ?>"><?php esc_html_e('Pricing & Licenses', 'edm-theme'); ?></a></li>
                    <li><a href="<?php echo esc_url(home_url('/edm/#knowledge-hub')); ?>"><?php esc_html_e('15-Step Guide', 'edm-theme'); ?></a></li>
                </ul>
            </div>
            ...
            <div class="footer-col">
                ...
                <ul class="footer-links">
                    ...
                    <li><a href="<?php echo esc_url(home_url('/edm/#faq')); ?>"><?php esc_html_e('Technical FAQ', 'edm-theme'); ?></a></li>
                    <li><a href="<?php echo esc_url(home_url('/contact/')); ?>"><?php esc_html_e('Help & Diagnostics', 'edm-theme'); ?></a></li>
                    <li><a href="<?php echo esc_url(home_url('/nf/')); ?>"><?php esc_html_e('SaaS Control Plane', 'edm-theme'); ?></a></li>
