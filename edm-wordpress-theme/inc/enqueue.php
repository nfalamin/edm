...
function edm_theme_scripts() {
    ...
    // 0. Tailwind CSS CDN Engine (Full Utility System & Grid)
    wp_enqueue_script(
        'tailwind-cdn',
    ...
    // 5. Theme Master Stylesheet (style.css)
    wp_enqueue_style('edm-style', get_stylesheet_uri(), array(), $theme_version);

    // 6. Global Design System Tokens & Base Reset
    wp_enqueue_style(
        'edm-global-style',
    ...
    // 7. Standalone Portfolio & Ecosystem CSS Bundle (Zero CDN Dependency)
    wp_enqueue_style(
        'edm-portfolio-bundle',
        $theme_uri . '/assets/css/portfolio-bundle.css',
        array('edm-global-style'),
        $theme_version
    );

    // 8. Modular Portfolio CSS
    wp_enqueue_style('portfolio-global', $theme_uri . '/assets/css/portfolio/global-colors.css', array('edm-portfolio-bundle'), $theme_version);
    ...
    // =========================================================================
    // ROUTE 1: DASHBOARD SPA (/dashboard, /nfdashbord, /nf)
    // =========================================================================
    if (is_page_template('page-dashboard.php') || is_page('dashboard') || is_page('nfdashbord') || is_page('nf')) {
        ...
        wp_enqueue_style(
            ...
            array('edm-portfolio-bundle'),
            $theme_version
        );

        // Real Vector Live Map Styles
        wp_enqueue_style(
            'edm-live-map-style',
            $theme_uri . '/assets/css/live-map.css',
        ...
        // Real Geographic Vector Live Map Engine
        wp_enqueue_script(
            'edm-live-map-engine',
            $theme_uri . '/assets/js/live-map.js',
            array('lucide-icons'),
            $theme_version,
            true
        );
        ...
        wp_enqueue_script(
            ...
            array('chart-js', 'lucide-icons', 'edm-mock-data', 'edm-live-map-engine'),
            $theme_version,
            true
        );
        ...
        wp_enqueue_style(
            ...
            array('edm-dashboard-style', 'edm-live-map-style'),
            $theme_version
        );
    } 
    // =========================================================================
    // ROUTE 2: EDM PRODUCT HUB (/edm) & SUBPAGES
    // =========================================================================
    if (is_page_template('page-edm.php') || is_page('edm') || is_page('downloads') || is_page('pricing') || is_page('features')) {
