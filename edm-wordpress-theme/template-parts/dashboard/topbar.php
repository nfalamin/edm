...
<header class="app-topbar">
    ...
    <div class="topbar-right">
        ...
        <!-- Theme Switcher -->
        <button class="btn-dash-icon" onclick="if(window.edmDashboard) window.edmDashboard.toggleTheme();" title="<?php esc_attr_e('Toggle Theme', 'edm-theme'); ?>" aria-label="<?php esc_attr_e('Toggle Theme', 'edm-theme'); ?>">
