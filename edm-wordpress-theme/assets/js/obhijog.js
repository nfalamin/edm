...
(function() {
    ...
    window.submitObhijogFeedback = async function() {
        ...
        const ticketId = 'EDM-TK-' + Math.floor(100000 + Math.random() * 900000);
        ...
        try {
            ...
            if (!res || !res.ok) {
                ...
                await fetch('/wp-admin/admin-ajax.php', { method: 'POST', body: formData }).catch(() => {});
            }
            ...
            if (statusWrap) {
                ...
                statusWrap.innerHTML = `
                    ...
                    <div style="font-size:12px;color:#cbd5e1;">ট্র্যাকিং টিকিট আইডি: <strong style="color:#38bdf8;">${ticketId}</strong></div>
